...
knex('players').select('players.id as player_id', 'player_stats_per_game.game_id as player_game_id', 'games.home_id as home_id', 'teams.id as team_id', 'games.away_id as away_id')
